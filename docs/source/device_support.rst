...
asynFloat32Array device support is selected with
...
asynFloat32Array device support is used to read or write arrays of up to
2000 coil values or up to 125 16-bit registers. It is also used to read
the histogram array of I/O times when histogramming is enabled.
...
.. list-table::
  ...
  * - 1, 2
    ...
    - MODBUS_DATA
    - waveform (input)
    - value = (epicsFloat32)Modbus data[]
  * - 3, 4, 23
    - 16-bit word
    - Array of 16, 32 or 64-bit words
    - MODBUS_DATA (or datatype-specific value)
